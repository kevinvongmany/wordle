...
function Key({ keyValue, colour, isLarge, used }) {
  ...
  return (
    <div 
      className={`w-9 h-12 md:w-24 md:h-24 m-0.5 md:m-1.5 rounded grid place-items-center text-sm md:text-2xl text-white font-sans cursor-pointer ${colour}`}
      style={{ backgroundColor: "	#9c2f2f" }}
