...
function GameOver() {
  ...
  return (
    <div className='gameOver mt-9 md:mt-12 text-center md:mb-6'>
        ...
        <h2 className="text-xl mt-6 md:text-3xl md:mt-10"><a href="https://www.twitch.tv/bogonmydog/clip/DeliciousBoxyCockroachCharlietheUnicorn-4R9RPx5apgHUl7Du" target='_blank' className='text-blue-500'>WORDL</a></h2>
    </div>
  )
}
