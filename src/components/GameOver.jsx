...
function GameOver() {
  ...
  return (
    <div className='gameOver mt-9 md:mt-12 text-center md:mb-6'>
        ...
        <h1 className="text-2xl md:text-5xl mb-4 md:mb-6">The word was: <a href="https://www.twitch.tv/bogonmydog/clip/DeliciousBoxyCockroachCharlietheUnicorn-4R9RPx5apgHUl7Du" target='_blank' className='text-blue-500'>WORDL</a></h1>
