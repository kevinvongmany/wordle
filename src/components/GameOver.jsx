...
function GameOver() {
  ...
  return (
    <div className='gameOver mt-9 md:mt-12 text-center md:mb-6'>
        ...
        {/* CUSTOM MESSAGE  */}
          <p className="text-xl md:text-3xl mt-3 font-bold">The emotes you see on page are from the great work of <a className="text-blue-600 underline" href='https://twitch.tv/mang0luck'>Mang0Luck</a>!</p>
          <p className="text-xl md:text-3xl mt-3 font-bold">Please check out their work at <a className="text-blue-600 underline" href='https://lam4ngo.carrd.co/'>https://lam4ngo.carrd.co/</a>!</p>
        <div className="mt-6 md:mt-12 flex items-center justify-center">
          ...
          <p className="text-xl md:text-xl mt-3">Want more Wordle? Check out my <a className="text-blue-600 underline" href='https://kevdle.netlify.app'>unthemed version</a>!</p>
        {/*  */}
    </div>
  )
}
